    ...
    <div class="max-w-md mx-auto mt-5 bg-black rounded-xl shadow-md p-4">
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                <img class="mx-auto h-30 w-28" src="{{asset('images/white_noise_gym_logo_2.png')}}" alt="White Noise Gym" />
            ...
            <form class="space-y-6" action="{{ route('login.auth') }}" method="POST">
                ...
                <div>
                    <button type="submit" class="flex w-full justify-center rounded-md px-3 py-1.5 text-sm/6 font-semibold shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2 bg-white text-gray-900 hover:bg-gray-50">
                        Sign in
                    </button>                
                </div>
            </form>
