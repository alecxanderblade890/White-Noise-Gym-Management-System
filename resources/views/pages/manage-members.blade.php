    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col md:flex-row gap-20 py-8 items-center justify-center">
            ...
            <a href="{{ route('register-member') }}" class="block group">
                <div class="bg-white rounded-lg shadow-md p-4 h-full border-2 border-transparent hover:border-gray-500 transition-all duration-300 transform hover:scale-105 max-w-xs w-full">
                    <div class="flex flex-col items-center text-center">
                        <div class="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center mb-4 group-hover:bg-gray-300 transition-colors duration-300">
